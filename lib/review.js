/* ============================================================
   ...
   Service-specific review flags are read from their modules
   to keep rules DRY and co-located with service config.
 ...
 */
import { REVIEW_REQUIRED as SEJOUR_REVIEW_REQUIRED, REVIEW_REASON as SEJOUR_REVIEW_REASON }
  from './services/sejour.js';
...
export function evaluateReview(order) {
  ...
  switch (service) {
    ...
    /* ── Mandatory review: titre de séjour — flags read from service module ── */
    case 'sejour':
      return {
        reviewRequired: SEJOUR_REVIEW_REQUIRED,
        reviewReason:   SEJOUR_REVIEW_REASON
      };
