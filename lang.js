...
const LANGS = [
  ...
  { code: 'gcr', flag: '🇬🇾', name: 'Creolese',         native: 'Guyanese Creole',     dir: 'ltr' },
];
...
const T = {
  ...
  gcr: {
    nav_comment: 'How am wuk',
    nav_services: 'Sarvice',
    nav_tarifs: 'Price',
    nav_cta: 'Mek mi request',
    hero_badge: '✅ Simple · Fast · Real',
    hero_t1: 'Yuh need help',
    hero_t2: 'wid yuh papers?',
    hero_t3: 'We handle everything.',
    hero_sub: 'CV, letter, document\u2026 mek yuh request in a few minute.',
    hero_btn1: 'Mek mi request',
    hero_btn2: 'How it wuk?',
    stat1: 'Request done',
    stat2: 'Average time',
    stat3: 'Happy',
    how_title: 'How it wuk?',
    how_sub: 'Tree simple step, no stress',
    s1_title: 'Yuh tell we wha yuh need',
    s1_desc: 'Fill in de form in a few minute wid de info yuh geh',
    s2_title: 'We wuk pun yuh request fast',
    s2_desc: 'Yuh document get prepare wid care an professionalism',
    s3_title: 'Yuh get yuh document',
    s3_desc: 'Download or get am by email, ready to use',
    svc_title: 'We sarvice',
    svc_sub: 'Everything yuh need fuh yuh paperwork',
    svc1_name: 'CV Mek',
    svc1_desc: 'A professional CV to help yuh get wuk',
    svc2_name: 'Motivation letter',
    svc2_desc: 'A personal letter fuh yuh application',
    svc3_name: 'Help wid file',
    svc3_desc: 'Help to put togeda yuh file fuh housing, wuk\u2026',
    svc4_name: 'Official letter',
    svc4_desc: 'Write letter fuh office an administration',
    from: 'from',
    btn_start: 'Start',
    btn_choose: 'Pick',
    adv1_t: 'Fast',            adv1_d: 'Done in less than 24h',
    adv2_t: 'Simple',          adv2_d: 'No big word, no confusion',
    adv3_t: 'No stress',       adv3_d: 'We handle everything fuh yuh',
    adv4_t: 'For everybody',   adv4_d: 'Match fuh every situation',
    pricing_title: 'Clear price, no hide fee',
    pricing_sub: 'Yuh know exactly wha yuh paying before yuh start',
    form_title: 'Mek yuh request',
    form_sub: 'Fill dis form, we handle de rest',
    testi_title: 'Dem trust we',
    footer_tagline: 'Simple admin help, wherever yuh deh.',
    footer_nav: 'Navigation',
    footer_contact: 'Contact',
    footer_legal: "Dok'péyi is a help service fuh writing an preparing document. Info must be check before use.",
    cv_ville_label:   'City / Town',
    cv_dispo_label:   'When yuh available',
    cv_secteur_label: 'Work sector',
    cv_niveau_label:  'Education level',
    cv_permis_label:  'Driver licence',
    cv_langues_label: 'Language dem yuh speak',
    cv_step1_short:   'Profile',
    cv_step2_short:   'Goal',
    cv_step3_short:   'Experience',
    cv_step4_short:   'Details',
    cv_step1_title:   'Who yuh is?',
    cv_step2_title:   'Yuh goal',
    cv_step3_title:   'Yuh experience',
    cv_step4_title:   'Last detail',
    lang_title: 'Choisissez votre langue',
    lang_sub: 'Choisissez · Escolha · Chwazi · Kies · اختر · Choose',
    lang_confirm: 'Continue →',
  },
